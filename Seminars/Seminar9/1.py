# Задача 1. Проверьте, существует ли связь между данными, приведенными в таблице. Выполните задание с помощью библиотеки Numpy
import numpy as np
...
result = np.corrcoef(matrix)  # Коэфицент корреляции 
print(result)
